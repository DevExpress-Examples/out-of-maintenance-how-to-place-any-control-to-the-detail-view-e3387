...
Namespace CustomGrid
	...
	Public Class CustomView
		...
		Private Sub CreateControl()
			fInternalView = CType(Activator.CreateInstance(Type.GetType(InternalControlType)), IDetailView)
		...
		Protected Overrides Function CalcRealViewHeight(ByVal rect As Rectangle) As Integer
		...
		<Description("Gets a value indicating whether the View is visible on screen.")> _
